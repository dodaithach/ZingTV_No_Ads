...
.method static synthetic access$000(Lorg/json/JSONObject;)Luf;
    .locals 1

    .prologue
    .line 45
    invoke-static {p0}, Lcom/facebook/applinks/FacebookAppLinkResolver;->getAndroidTargetFromJson(Lorg/json/JSONObject;)Luf;
...
.method private static getAndroidTargetFromJson(Lorg/json/JSONObject;)Luf;
    .locals 5
    ...
    invoke-direct {v1, v2, v3, v0, v4}, Luf;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
...
# virtual methods
.method public getAppLinkFromUrlInBackground(Landroid/net/Uri;)Lul;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 70
    invoke-virtual {p0, v0}, Lcom/facebook/applinks/FacebookAppLinkResolver;->getAppLinkFromUrlsInBackground(Ljava/util/List;)Lul;
    ...
    .line 1662
    sget-object v2, Lul;->b:Ljava/util/concurrent/Executor;

    .line 2638
    new-instance v3, Lul$2;

    invoke-direct {v3, v0, v1}, Lul$2;-><init>(Lul;Luk;)V

    .line 3574
    invoke-virtual {v0, v3, v2}, Lul;->a(Luk;Ljava/util/concurrent/Executor;)Lul;
...
.method public getAppLinkFromUrlsInBackground(Ljava/util/List;)Lul;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 112
    invoke-static {v4}, Lul;->a(Ljava/lang/Object;)Lul;
    ...
    invoke-direct {v5, p0, v7, v4, v6}, Lcom/facebook/applinks/FacebookAppLinkResolver$2;-><init>(Lcom/facebook/applinks/FacebookAppLinkResolver;Lum;Ljava/util/Map;Ljava/util/HashSet;)V
