...
.method private a(Ljava/lang/String;)Lcxy;
    .locals 2
    ...
    invoke-static {p0, v0}, Lcxy;->a(Landroid/content/Context;Landroid/os/Bundle;)Lcxy;
...
.method static a(Landroid/content/Context;Lcom/google/firebase/iid/FirebaseInstanceId;)V
    ...
    invoke-static {}, Lcom/google/firebase/iid/FirebaseInstanceId;->d()Lcxz;

    move-result-object v0

    invoke-virtual {v0}, Lcxz;->a()Ljava/lang/String;
...
.method private d(Landroid/content/Intent;)V
    ...
    .line 4000
    iget-object v3, v0, Lcom/google/firebase/iid/FirebaseInstanceId;->a:Lcxy;

    const/4 v4, 0x0

    invoke-virtual {v3, v1, v2, v4}, Lcxy;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v5}, Lcxz;->a()Ljava/lang/String;
    ...
    :cond_5
    :goto_3
    invoke-virtual {v5, v0}, Lcxz;->a(Ljava/lang/String;)Z
    ...
    iget-object v8, v2, Lcom/google/firebase/iid/FirebaseInstanceId;->a:Lcxy;
    ...
    :goto_5
    invoke-virtual {v8, v2, v1, v7}, Lcxy;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 7000
    :cond_c
    sget-object v6, Lcxy;->c:Lcyb;

    iget-object v9, v8, Lcxy;->f:Ljava/lang/String;

    invoke-virtual {v6, v9, v1, v2}, Lcyb;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v1, Lcxy;->d:Lcya;

    invoke-virtual {v8}, Lcxy;->a()Ljava/security/KeyPair;

    move-result-object v2

    invoke-virtual {v1, v7, v2}, Lcya;->a(Landroid/os/Bundle;Ljava/security/KeyPair;)Landroid/content/Intent;

    move-result-object v1

    invoke-static {v1}, Lcya;->b(Landroid/content/Intent;)Ljava/lang/String;

    goto/16 :goto_3

    :cond_e
    iget-object v2, v8, Lcxy;->f:Ljava/lang/String;

    goto :goto_8

    :cond_f
    iget-object v1, v8, Lcxy;->f:Ljava/lang/String;
    :try_end_6
...
.method protected final a(Landroid/content/Intent;)I
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, v0}, Lcom/google/firebase/iid/FirebaseInstanceIdService;->a(Ljava/lang/String;)Lcxy;

    invoke-static {}, Lcxy;->d()Lcya;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcya;->c(Landroid/content/Intent;)V
    ...
    :cond_3
    invoke-super {p0, p1}, Lcom/google/firebase/iid/zzb;->a(Landroid/content/Intent;)I
...
.method public final b(Landroid/content/Intent;)V
    ...
    :cond_3
    invoke-virtual {v1, v0}, Lcyb;->c(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lcya;->a(Landroid/content/Intent;)V
