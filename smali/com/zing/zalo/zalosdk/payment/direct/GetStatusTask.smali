...
.method public execute()Lorg/json/JSONObject;
    ...
    const-string v1, "GetStatusTask======== execute"
    ...
    :cond_0
    :try_start_0
    const-string v0, "get_status_timeOut"
    ...
    const-string v3, "GetStatusTask======== timeOut: "
    ...
    const-string v7, "GetStatusTask======== request.getParamsString(): "
    ...
    .line 79
    const-string v3, "GetStatusTask request: "
    ...
    const-string v3, "GetStatusTask======== request.getJSON() done"
    ...
    const-string v3, "purchase successfull! status 0"
    ...
    const-string v4, "GetStatusTask======== exception: "
    ...
    const-string v2, "purchase successfull! status 1========== run SubmitPaymentCompleteTask.java"
...
.method public onCompleted(Lorg/json/JSONObject;)V
    ...
    const-string v3, "GetStatusTask======== onCompleted"
    ...
    .line 134
    const-string v2, "GetStatusTask result: "
    ...
    .line 153
    :cond_0
    const-string v0, "zalosdk_last_success_card_channel"
    ...
    .line 154
    :cond_1
    const-string v0, "zalosdk_last_success_channel"
    ...
    const-string v1, "GetStatusTask.java====onCompleted==owner.onPaymentComplete(result)="
