...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GcmListenerService;->zzail:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, Lcom/google/android/gms/gcm/GcmListenerService;->Za:I
...
.method private zzble()V
    .locals 2

    iget-object v1, p0, Lcom/google/android/gms/gcm/GcmListenerService;->zzail:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget v0, p0, Lcom/google/android/gms/gcm/GcmListenerService;->Za:I
    ...
    iget v0, p0, Lcom/google/android/gms/gcm/GcmListenerService;->YZ:I

    invoke-virtual {p0, v0}, Lcom/google/android/gms/gcm/GcmListenerService;->zzsl(I)Z
...
.method private zzm(Landroid/content/Intent;)V
    ...
    :goto_1
    invoke-direct {p0}, Lcom/google/android/gms/gcm/GcmListenerService;->zzble()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private zzo(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/gcm/zza;->zzac(Landroid/os/Bundle;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0}, Lcom/google/android/gms/gcm/zza;->zzdc(Landroid/content/Context;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-static {p0}, Lcom/google/android/gms/gcm/zza;->zzdb(Landroid/content/Context;)Lcom/google/android/gms/gcm/zza;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/google/android/gms/gcm/zza;->zzae(Landroid/os/Bundle;)Z

    :goto_0
    return-void

    :cond_0
    invoke-static {v0}, Lcom/google/android/gms/gcm/zza;->zzad(Landroid/os/Bundle;)V
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    :try_start_0
    iput p3, p0, Lcom/google/android/gms/gcm/GcmListenerService;->YZ:I
