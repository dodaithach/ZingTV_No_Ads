...
.field private volatile b:Lbks;

.field private volatile c:Z


# direct methods
.method protected constructor <init>(Lblt;)V
    .locals 0
...
.method public final a()Lbks;
    ...
    iget-object v2, p0, Lblu;->a:Lblt;

    .line 2000
    iget-object v2, v2, Lbln;->h:Lblq;
    ...
    :try_start_0
    iput-object v4, p0, Lblu;->b:Lbks;

    const/4 v4, 0x1

    iput-boolean v4, p0, Lblu;->c:Z

    iget-object v4, p0, Lblu;->a:Lblt;

    .line 4000
    iget-object v4, v4, Lblt;->a:Lblu;
    ...
    invoke-virtual {v2, v3, v4}, Lblt;->a(Ljava/lang/String;Ljava/lang/Object;)V

    if-nez v1, :cond_0

    const/4 v1, 0x0

    iput-boolean v1, p0, Lblu;->c:Z
    ...
    iget-object v0, p0, Lblu;->b:Lbks;

    const/4 v1, 0x0

    iput-object v1, p0, Lblu;->b:Lbks;

    if-nez v0, :cond_1

    iget-object v1, p0, Lblu;->a:Lblt;

    const-string v2, "Successfully bound to service but never got onServiceConnected callback"

    invoke-virtual {v1, v2}, Lblt;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lblt;->e(Ljava/lang/String;)V
    :try_end_3
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v1}, Lblt;->f(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {p2}, Lbkt;->a(Landroid/os/IBinder;)Lbks;
    ...
    invoke-virtual {v1, v2}, Lblt;->b(Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-virtual {v2, v3, v1}, Lblt;->e(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_5
    ...
    invoke-virtual {v1, v2}, Lblt;->e(Ljava/lang/String;)V
    ...
    .line 0
    new-instance v2, Lblu$1;

    invoke-direct {v2, p0, v0}, Lblu$1;-><init>(Lblu;Lbks;)V
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    .line 0
    new-instance v1, Lblu$2;

    invoke-direct {v1, p0, p1}, Lblu$2;-><init>(Lblu;Landroid/content/ComponentName;)V
