...
.method private a(II)V
    ...
    .line 520
    iget-object v1, p0, Ln;->e:Landroid/graphics/drawable/ColorDrawable;
    ...
    iput-object v1, p0, Ln;->e:Landroid/graphics/drawable/ColorDrawable;
...
.method final a()V
    ...
    .line 456
    iget-object v0, p0, Ln;->c:Ll;

    invoke-static {v0}, Ll;->a(Ll;)Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 458
    invoke-virtual {p0, v0}, Ln;->a(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    iget-object v6, p0, Ln;->c:Ll;

    invoke-static {v6}, Ll;->k(Ll;)I
    ...
    invoke-direct {v2, v0, v6}, Lr;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;B)V
    ...
    invoke-direct {v13, v1, v14}, Lr;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;B)V
    ...
    iget-object v5, p0, Ln;->c:Ll;

    .line 499
    invoke-static {v5}, Ll;->k(Ll;)I

    move-result v5

    iget-object v9, p0, Ln;->c:Ll;

    invoke-static {v9}, Ll;->k(Ll;)I
    ...
    invoke-direct {v4, v0, v5}, Lr;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;B)V
    ...
    invoke-direct {p0, v4, v1}, Ln;->a(II)V
...
.method public final a(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    .prologue
    .line 529
    iget-object v0, p0, Ln;->d:Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 535
    :cond_2
    iput-object p1, p0, Ln;->d:Landroid/support/v7/view/menu/MenuItemImpl;
...
.method public final b()Landroid/os/Bundle;
    ...
    iget-object v2, p0, Ln;->d:Landroid/support/v7/view/menu/MenuItemImpl;
...
.method public final synthetic onBindViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    .line 5392
    invoke-virtual {p0, p2}, Ln;->getItemViewType(I)I
    ...
    .line 5394
    :pswitch_0
    iget-object v0, p1, Lv;->itemView:Landroid/view/View;
    ...
    invoke-static {v1}, Ll;->f(Ll;)Landroid/content/res/ColorStateList;
    ...
    iget-object v2, p0, Ln;->c:Ll;

    invoke-static {v2}, Ll;->h(Ll;)I
    ...
    invoke-static {v1}, Ll;->i(Ll;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Ll;->j(Ll;)Landroid/graphics/drawable/Drawable;
    ...
    .line 6615
    iget-object v1, v1, Lr;->a:Landroid/support/v7/view/menu/MenuItemImpl;

    .line 5405
    invoke-virtual {v0, v1, v4}, Landroid/support/design/internal/NavigationMenuItemView;->initialize(Landroid/support/v7/view/menu/MenuItemImpl;I)V
    ...
    .line 5417
    iget-object v1, p1, Lv;->itemView:Landroid/view/View;
...
.method public final synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {v1}, Ll;->c(Ll;)Landroid/view/LayoutInflater;

    move-result-object v1

    iget-object v2, p0, Ln;->c:Ll;

    invoke-static {v2}, Ll;->d(Ll;)Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v0, v1, p1}, Lu;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V
    ...
    invoke-static {v1}, Ll;->e(Ll;)Landroid/widget/LinearLayout;

    move-result-object v1

    invoke-direct {v0, v1}, Lm;-><init>(Landroid/view/View;)V
