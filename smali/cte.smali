...
# direct methods
.method constructor <init>(Lctb;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2

    iput-object p1, p0, Lcte;->a:Lctb;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .prologue
    .line 0
    invoke-direct {p0, p1, p2}, Lcte;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Lcte;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    iget-object v1, p0, Lcte;->a:Lctb;

    invoke-virtual {v1}, Lctb;->v()Lcts;
    ...
    invoke-virtual {v1, v2, p2}, Lctt;->a(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lcte;->a:Lctb;

    invoke-virtual {v2}, Lctb;->v()Lcts;
...
.method public final getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v1}, Lctb;->a(Lctb;)Lcst;

    move-result-object v1

    invoke-static {}, Lcta;->H()J

    .line 1000
    iget-wide v2, v1, Lcst;->b:J
    ...
    .line 1000
    :cond_1
    iget-object v2, v1, Lcst;->a:Lcom/google/android/gms/common/util/zze;

    invoke-interface {v2}, Lcom/google/android/gms/common/util/zze;->elapsedRealtime()J

    move-result-wide v2

    iget-wide v4, v1, Lcst;->b:J
    ...
    iget-object v0, p0, Lcte;->a:Lctb;

    invoke-static {v0}, Lctb;->a(Lctb;)Lcst;
    ...
    invoke-virtual {v1}, Lctb;->p()Landroid/content/Context;
...
.method public final onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcte;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {}, Lctb;->C()Ljava/util/Map;
    ...
    invoke-direct/range {v6 .. v11}, Lcte;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
