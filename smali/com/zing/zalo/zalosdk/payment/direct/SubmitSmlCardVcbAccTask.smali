...
.method public execute()Lorg/json/JSONObject;
    ...
    invoke-virtual {v0, v4}, Lcom/zing/zalo/zalosdk/model/ViewFactory;->getParamValue(Lcom/zing/zalo/zalosdk/payment/direct/CommonPaymentAdapter;)Ljava/util/List;
    ...
    const-string v2, "Vui l\u00f2ng nh\u1eadp t\u00ean truy c\u1eadp VCB-iB@nking"
    ...
    const-string v8, "document.getElementById(\'ctl00__Default_Content_Center"
    ...
    const-string v7, "\').value=decodeURI(\'"
    ...
    .line 56
    :cond_5
    const-string v7, "_Random_Img_Str"
    ...
    .line 57
    const-string v4, "_Random_Img_Str"
    ...
    const-string v2, "Vui l\u00f2ng nh\u1eadp m\u1eadt kh\u1ea9u VCB-iB@nking"
    ...
    const-string v2, "Vui l\u00f2ng nh\u1eadp chu\u1ed7i k\u00fd t\u1ef1 b\u1ea3o m\u1eadt"
    ...
    .line 112
    const-string v1, "var ec = document.getElementById(\'ctl00__Default_Content_Center_Chk_Terms\'); var ocfunc = ec[\'onclick\'];ec.checked=\'false\'; if (typeof(ocfunc) == \'function\') {ocfunc.call(ec);};"
    ...
    .line 114
    const-string v1, "document.getElementById(\'ctl00__Default_Content_Center_Confirm\').click();"
    ...
    .line 116
    const-string v1, "window.location=\'http://sdk.jsexception\';"
