...
.field private static final sPositionComparator:Low;


# instance fields
.field private mActivePointerId:I

.field private mAdapter:Lmr;
...
.field private mInternalPageChangeListener:Los;
...
.field private mObserver:Lou;

.field private mOffscreenPageLimit:I

.field private mOnPageChangeListener:Los;
...
.field private mPageTransformer:Lot;
...
.field private final mTempItem:Lop;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->sPositionComparator:Low;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->mTempItem:Lop;
...
.method public static synthetic access$200(Landroid/support/v4/view/ViewPager;)Lmr;
    .locals 1

    .prologue
    .line 109
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;
...
.method private calculatePageOffsets(Lop;ILop;)V
    .locals 12
    ...
    .line 1310
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    invoke-virtual {v5, v2}, Lmr;->getPageWidth(I)F
    ...
    .line 1350
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    add-int/lit8 v3, v2, -0x1

    invoke-virtual {v9, v2}, Lmr;->getPageWidth(I)F
...
.method private completeScroll(Z)V
    ...
    .line 1980
    iget-boolean v5, v0, Lop;->c:Z

    if-eqz v5, :cond_2

    .line 1982
    iput-boolean v2, v0, Lop;->c:Z
...
.method private dispatchOnPageScrolled(IFI)V
    ...
    .prologue
    .line 1907
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Los;
    ...
    .line 1918
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Los;
...
.method private enableLayers(Z)V
    ...
    invoke-static {v4, v0, v5}, Lni;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
...
.method private infoForCurrentScrollPosition()Lop;
    .locals 13
    ...
    .line 2356
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mTempItem:Lop;
    ...
    .line 2359
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    iget v7, v0, Lop;->b:I

    invoke-virtual {v6, v7}, Lmr;->getPageWidth(I)F
...
.method private pageScrolled(I)Z
    ...
    .line 1816
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->infoForCurrentScrollPosition()Lop;
...
.method private performDrag(F)Z
    ...
    invoke-virtual {v9}, Lmr;->getCount()I
    ...
    .line 2319
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lsi;
    ...
    invoke-virtual {v1, v0}, Lsi;->a(F)Z
    ...
    .line 2325
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lsi;
    ...
    invoke-virtual {v2, v0}, Lsi;->a(F)Z
...
.method private recomputeScrollPosition(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Lop;
...
.method private resetTouch()Z
    ...
    .line 2279
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lsi;

    invoke-virtual {v0}, Lsi;->c()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lsi;

    invoke-virtual {v1}, Lsi;->c()Z
...
.method private scrollToItem(IZIZ)V
    ...
    .line 673
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Lop;
...
.method private setScrollState(I)V
    ...
    .line 491
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Lot;
...
.method private sortChildDrawingOrder()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->sPositionComparator:Low;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2874
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Lop;
...
.method addNewItem(II)Lop;
    ...
    .line 1001
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    invoke-virtual {v1, p0, p1}, Lmr;->instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Lop;->a:Ljava/lang/Object;

    .line 1002
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    invoke-virtual {v1, p1}, Lmr;->getPageWidth(I)F
...
.method public addOnAdapterChangeListener(Lor;)V
    .locals 1
...
.method public addOnPageChangeListener(Los;)V
    .locals 1
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 2916
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Lop;
...
.method protected canScroll(Landroid/view/View;ZIII)Z
    ...
    invoke-static {p1, v0}, Lni;->a(Landroid/view/View;I)Z
...
.method public canScrollHorizontally(I)Z
    ...
    .line 2664
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;
...
.method public dataSetChanged()V
    ...
    .line 1023
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    iget-object v9, v0, Lop;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Lmr;->getItemPosition(Ljava/lang/Object;)I
    ...
    .line 1034
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    invoke-virtual {v4, p0}, Lmr;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Lmr;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p0}, Lmr;->finishUpdate(Landroid/view/ViewGroup;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 2408
    invoke-static {p0}, Lni;->a(Landroid/view/View;)I
    ...
    .line 2411
    invoke-virtual {v1}, Lmr;->getCount()I
    ...
    .line 2419
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lsi;

    invoke-virtual {v3, v0, v2}, Lsi;->a(II)V

    .line 2420
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lsi;

    invoke-virtual {v0, p1}, Lsi;->a(Landroid/graphics/Canvas;)Z
    ...
    .line 2430
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lsi;

    invoke-virtual {v4, v3, v2}, Lsi;->a(II)V

    .line 2431
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lsi;

    invoke-virtual {v2, p1}, Lsi;->a(Landroid/graphics/Canvas;)Z
...
.method public endFakeDrag()V
    ...
    invoke-static {v0, v1}, Lne;->a(Landroid/view/VelocityTracker;I)F
...
.method public executeKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 2741
    invoke-static {p1}, Llg;->b(Landroid/view/KeyEvent;)Z
    ...
    .line 2743
    :cond_1
    invoke-static {p1}, Llg;->a(Landroid/view/KeyEvent;)Z
...
.method public fakeDragBy(F)V
    ...
    invoke-virtual {v6}, Lmr;->getCount()I
...
.method infoForAnyChild(Landroid/view/View;)Lop;
    .locals 2
    ...
    .line 1516
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Lop;
...
.method infoForChild(Landroid/view/View;)Lop;
    .locals 4
    ...
    iget-object v3, v0, Lop;->a:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Lmr;->isViewFromObject(Landroid/view/View;Ljava/lang/Object;)Z
...
.method initViewPager()V
    ...
    .line 407
    invoke-static {v1}, Lob;->a(Landroid/view/ViewConfiguration;)I
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lsi;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lsi;
    ...
    invoke-direct {v0, p0}, Loq;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    invoke-virtual {v3, v5}, Lmr;->getPageWidth(I)F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2059
    invoke-static {p1, v0}, Lmf;->d(Landroid/view/MotionEvent;I)F
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Lop;
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 2946
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Lop;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1, v2}, Lmr;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Lmr;->saveState()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v2}, Lne;->a(Landroid/view/VelocityTracker;I)F
    ...
    .line 2240
    invoke-static {p1, v3}, Lmf;->a(Landroid/view/MotionEvent;I)I

    move-result v3

    .line 2241
    invoke-static {p1, v3}, Lmf;->c(Landroid/view/MotionEvent;I)F
...
.method populate(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Lop;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;
    ...
    invoke-virtual {v2, v0}, Lmr;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    invoke-virtual {v4}, Lmr;->getCount()I
    ...
    invoke-virtual {v0, v2, v4}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Lop;
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    iget-object v2, v2, Lop;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v14, v0, v8, v2}, Lmr;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v8, v2}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Lop;
    ...
    iget-object v10, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    iget-object v2, v2, Lop;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v10, v0, v8, v2}, Lmr;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v8, v6}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Lop;
    ...
    invoke-direct {v0, v9, v7, v3}, Landroid/support/v4/view/ViewPager;->calculatePageOffsets(Lop;ILop;)V
    ...
    iget-object v2, v9, Lop;->a:Ljava/lang/Object;

    :goto_11
    move-object/from16 v0, p0

    invoke-virtual {v3, v0, v4, v2}, Lmr;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Lmr;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Lop;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->infoForAnyChild(Landroid/view/View;)Lop;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Lop;
...
.method public removeOnAdapterChangeListener(Lor;)V
    .locals 1
...
.method public removeOnPageChangeListener(Los;)V
    .locals 1
...
.method public setAdapter(Lmr;)V
    .locals 7
    ...
    invoke-virtual {v0, v5}, Lmr;->setViewPagerObserver(Landroid/database/DataSetObserver;)V

    .line 506
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    invoke-virtual {v0, p0}, Lmr;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    .line 509
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    iget v4, v0, Lop;->b:I

    iget-object v0, v0, Lop;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Lmr;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 519
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;
    ...
    .line 523
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mObserver:Lou;
    ...
    invoke-direct {v0, p0, v2}, Lou;-><init>(Landroid/support/v4/view/ViewPager;B)V

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->mObserver:Lou;

    .line 526
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lmr;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mObserver:Lou;

    invoke-virtual {v0, v3}, Lmr;->setViewPagerObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v3}, Lmr;->getCount()I
    ...
    invoke-virtual {v0, v3, v4}, Lmr;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    invoke-interface {v0, p0, v1, p1}, Lor;->a(Landroid/support/v4/view/ViewPager;Lmr;Lmr;)V
...
.method setInternalPageChangeListener(Los;)Los;
    .locals 1
    ...
    .line 807
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Los;
...
.method public setOnPageChangeListener(Los;)V
    ...
    .prologue
    .line 706
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Los;
...
.method public setPageTransformer(ZLot;)V
    .locals 4
    ...
    .line 762
    :goto_0
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Lot;
    ...
    .line 763
    :goto_2
    iput-object p2, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Lot;
...
.method smoothScrollTo(III)V
    ...
    invoke-virtual {v5, v7}, Lmr;->getPageWidth(I)F
