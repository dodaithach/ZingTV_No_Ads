...
.method public onPageFinished(Landroid/webkit/WebView;Ljava/lang/String;)V
    ...
    const-string v1, "javascript:{function closePopup() {test.closePopup();};function exitApp() {test.exitApp();};function openStore(link, closePopup) {test.openStore(link, closePopup);}function openApp(link, closePopup) {test.openApp(link, closePopup);}function openAppThenStore(link, closePopup) {test.openAppThenStore(link, closePopup);}function openPage(link, closePopup) {test.openPage(link, closePopup);};}"
