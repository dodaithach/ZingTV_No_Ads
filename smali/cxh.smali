...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, Lcxh;-><init>(Landroid/content/Context;Lcom/google/android/gms/common/util/zze;Ljava/lang/String;Ljava/util/concurrent/Executor;)V
...
.method private constructor <init>(Landroid/content/Context;Lcom/google/android/gms/common/util/zze;Ljava/lang/String;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p2, p0, Lcxh;->e:Lcom/google/android/gms/common/util/zze;

    const/16 v0, 0x7d0

    iput v0, p0, Lcxh;->f:I

    iput-object p4, p0, Lcxh;->b:Ljava/util/concurrent/Executor;

    new-instance v0, Lcxi;

    iget-object v1, p0, Lcxh;->c:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p3}, Lcxi;-><init>(Lcxh;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcxh;->d:Lcxi;
...
.method private a(I)Ljava/util/List;
    ...
    :cond_0
    invoke-direct {p0}, Lcxh;->e()Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic a(Lcxh;)Ljava/util/List;
    .locals 1

    invoke-direct {p0}, Lcxh;->b()Ljava/util/List;
...
.method static synthetic a(Lcxh;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcxh;->b(Ljava/util/List;J)V
...
.method static synthetic b(Lcxh;)Landroid/content/Context;
    .locals 1
...
.method private b()Ljava/util/List;
    ...
    .line 0
    :try_start_0
    iget-object v0, p0, Lcxh;->e:Lcom/google/android/gms/common/util/zze;

    invoke-interface {v0}, Lcom/google/android/gms/common/util/zze;->currentTimeMillis()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lcxh;->a(J)V

    invoke-direct {p0}, Lcxh;->c()Ljava/util/List;
    ...
    iget-object v4, v0, Lcxj;->a:Ljava/lang/String;

    iget-object v0, v0, Lcxj;->b:[B

    invoke-static {v0}, Lcxh;->a([B)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lcvj;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private declared-synchronized b(Ljava/util/List;J)V
    ...
    invoke-direct {p0, v2, v3}, Lcxh;->a(J)V
    ...
    invoke-direct {p0, v0}, Lcxh;->a(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0, v1}, Lcxh;->c(Ljava/util/List;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private c()Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lcxj;-><init>(Ljava/lang/String;[B)V
...
.method private c(Ljava/util/List;J)V
    ...
    iget-object v5, v0, Lcxj;->a:Ljava/lang/String;
...
.method private e()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lcxh;->d:Lcxi;

    invoke-virtual {v0}, Lcxi;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private f()V
    ...
    invoke-virtual {v0}, Lcxi;->close()V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Lcvm;)V
    ...
    iget-object v0, p0, Lcxh;->b:Ljava/util/concurrent/Executor;

    new-instance v1, Lcxh$2;

    invoke-direct {v1, p0, p1}, Lcxh$2;-><init>(Lcxh;Lcvm;)V
...
.method public final a(Ljava/util/List;J)V
    ...
    invoke-static {v0}, Lcxh;->a(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lcxj;-><init>(Ljava/lang/String;[B)V
    ...
    new-instance v2, Lcxh$1;

    invoke-direct {v2, p0, v1, p2, p3}, Lcxh$1;-><init>(Lcxh;Ljava/util/List;J)V
