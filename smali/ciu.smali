...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/cast/framework/CastOptions;Lcjj;)V
    ...
    iput-object p2, p0, Lciu;->a:Lcom/google/android/gms/cast/framework/CastOptions;

    iput-object p3, p0, Lciu;->b:Lcjj;
...
.method public final createSession(Ljava/lang/String;)Lcom/google/android/gms/cast/framework/Session;
    ...
    invoke-virtual {p0}, Lciu;->getCategory()Ljava/lang/String;

    move-result-object v2

    iget-object v4, p0, Lciu;->a:Lcom/google/android/gms/cast/framework/CastOptions;

    sget-object v5, Lcom/google/android/gms/cast/Cast;->CastApi:Lcom/google/android/gms/cast/Cast$CastApi;

    new-instance v6, Lciv;

    invoke-direct {v6}, Lciv;-><init>()V
    ...
    iget-object v8, p0, Lciu;->a:Lcom/google/android/gms/cast/framework/CastOptions;

    iget-object v9, p0, Lciu;->b:Lcjj;

    invoke-direct {v7, v3, v8, v9}, Lcjs;-><init>(Landroid/content/Context;Lcom/google/android/gms/cast/framework/CastOptions;Lcjj;)V

    move-object v3, p1

    invoke-direct/range {v0 .. v7}, Lcom/google/android/gms/cast/framework/CastSession;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/cast/framework/CastOptions;Lcom/google/android/gms/cast/Cast$CastApi;Lciv;Lcjs;)V
...
.method public final isSessionRecoverable()Z
    ...
    iget-object v0, p0, Lciu;->a:Lcom/google/android/gms/cast/framework/CastOptions;
