...
.method private init(Landroid/content/Context;)V
    ...
    .line 65
    const-string v1, "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36"
...
.method private initZingCharge(Ljava/lang/String;)V
    ...
    .line 81
    const-string v1, "javascript:{ var result = {pageId:-1};"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 82
    const-string v1, "if (document.getElementById(\'frmCharge\') != null && document.getElementById(\'frmCharge\').length > 0) { "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 83
    const-string v1, "result = {pageId:2};"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 84
    const-string v1, "result.currentAmount = document.getElementsByClassName(\'ico-xu\')[0].innerHTML; "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 85
    const-string v1, "result.acc=\'"
    ...
    .line 86
    const-string v1, "else if (document.getElementById(\'frmLogin\') != null && document.getElementById(\'frmLogin\').length > 0) { result = {pageId:1}; "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 87
    const-string v1, "if (document.getElementById(\'login_error\') != null && document.getElementById(\'login_error\').innerHTML.length > 0) result.mes = \'invalid_acc\' }"
    ...
    const-string v2, " initZingCharge"
...
.method private notifyPaymentComplete(Ljava/lang/String;)V
    ...
    const-string v2, "javascript:{ var result = {pageId:3}; result.mes =\'"
    ...
    const-string v2, " notifyPaymentComplete"
...
.method protected logOut()V
    ...
    .line 74
    const-string v1, "javascript:{submitLogout();}"
