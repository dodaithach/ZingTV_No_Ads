...
# virtual methods
.method final callOnLoadFinished(Ldy;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2498
    invoke-static {p2, v2}, Ljt;->a(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Ldy;Ljava/lang/Object;)V
    :try_end_0
...
.method final cancel()Z
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Ldy;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->onLoadCanceled(Ldy;)V
...
.method final destroy()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Ldy;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Ldy;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Ldy;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, p0}, Ldy;->a(Lea;)V

    .line 374
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Ldy;

    invoke-virtual {v0, p0}, Ldy;->a(Ldz;)V
    ...
    .line 2421
    iput-boolean v5, v0, Ldy;->f:Z

    .line 2422
    iput-boolean v4, v0, Ldy;->d:Z

    .line 2423
    iput-boolean v4, v0, Ldy;->e:Z

    .line 2424
    iput-boolean v4, v0, Ldy;->g:Z

    .line 2425
    iput-boolean v4, v0, Ldy;->h:Z
...
.method public final dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v2, v0, Ldy;->g:Z

    if-nez v2, :cond_0

    iget-boolean v2, v0, Ldy;->h:Z
    ...
    .line 2529
    :cond_1
    iget-boolean v2, v0, Ldy;->e:Z

    if-nez v2, :cond_2

    iget-boolean v2, v0, Ldy;->f:Z
...
.method final finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Ldy;Ljava/lang/Object;)V
...
.method public final onLoadCanceled(Ldy;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Lkj;

    iget v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v0, v1}, Lkj;->a(I)Ljava/lang/Object;
    ...
    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Lkj;

    iget v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v1, v2, v3}, Lkj;->a(ILjava/lang/Object;)V
...
.method public final onLoadComplete(Ldy;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 447
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Ldy;Ljava/lang/Object;)V

    .line 457
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->this$0:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Lkj;
...
.method final start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Ldy;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Ldy;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Ldy;
    ...
    .line 1269
    iput-boolean v3, v0, Ldy;->d:Z

    .line 1270
    iput-boolean v4, v0, Ldy;->f:Z
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Ljt;->a(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
