...
.field private static final q:Lmt;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Lmt;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0, v0}, Lms;-><init>(Landroid/support/v4/view/PagerTitleStrip;B)V

    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lms;
...
.method private static setSingleLineAllCaps(Landroid/widget/TextView;)V
    ...
    .prologue
    .line 111
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Lmt;

    invoke-interface {v0, p0}, Lmt;->a(Landroid/widget/TextView;)V
...
.method public a(IFZ)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILmr;)V
...
.method public final a(ILmr;)V
    ...
    invoke-virtual {p2}, Lmr;->getCount()I
    ...
    invoke-virtual {p2, v2}, Lmr;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    .line 284
    invoke-virtual {p2, p1}, Lmr;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, v0}, Lmr;->getPageTitle(I)Ljava/lang/CharSequence;
...
.method public final a(Lmr;Lmr;)V
    .locals 1
    ...
    .line 321
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lms;

    invoke-virtual {p1, v0}, Lmr;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Lmr;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILmr;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 256
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lms;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->setInternalPageChangeListener(Los;)Los;

    .line 257
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lms;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->addOnAdapterChangeListener(Lor;)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->a(Lmr;Lmr;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(Lmr;Lmr;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lms;
...
.method protected onMeasure(II)V
    ...
    invoke-static {v0, p2, v1}, Lni;->a(III)I
